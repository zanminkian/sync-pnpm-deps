...
import type { ImporterNodeV5_4 } from './interfaces.js'
 ...
 */
export function checkImporter(importers: Record<string, ImporterNodeV5_4>, store: Map<string, string>, chain: string[], options?: { prod?: boolean }) {
